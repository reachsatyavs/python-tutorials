...
|---|-----------|----------------|
| 01 | [`01-python-intro/`](01-python-intro/README.md) | Why Python; install, venv, JupyterLab (Windows & macOS) |
...
| File | What it is |
|------|------------|
| `README.md` | This file — course index |
...
**Module 01** — motivation and environment setup: [`01-python-intro/README.md`](01-python-intro/README.md)
